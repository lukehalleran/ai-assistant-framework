...
def test_topic_change_scenario():
    ...
    conversations = [
        {
            "id": 1,
            "query": "Yo man. I woke up at a decent time today like 830 I think and slept okay. Thinking I'm due for a break though super fried. I'm at the gym rn and then haircut and then maybe I'll hang with sam if he responds but definitely taking it easy today I think",
