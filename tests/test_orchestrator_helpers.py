...
def test_strip_xml_wrappers_result_tag():
    ...
    result = ResponseParser.strip_xml_wrappers(text)
...
def test_strip_xml_wrappers_empty():
    ...
    result = ResponseParser.strip_xml_wrappers("")
    assert result == ""


def test_strip_xml_wrappers_none():
    """Test stripping with None."""
    result = ResponseParser.strip_xml_wrappers(None)
...
def test_strip_prompt_artifacts_empty():
    """Test stripping with empty text."""
    result = ResponseParser.strip_prompt_artifacts("")
    assert result == ""


def test_strip_prompt_artifacts_none():
    """Test stripping with None."""
    result = ResponseParser.strip_prompt_artifacts(None)
    assert result is None
