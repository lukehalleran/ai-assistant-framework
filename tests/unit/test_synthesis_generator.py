...
def mock_store():
    ...
    facts_pool = [
        ...
        _make_fact_item("f2", "user", "has_cat", "Mochi", "User has a cat named Mochi"),
...
class TestSynthesisGenerator:
    ...
    def test_extract_concept_name_personal_fact(self, mock_store, mock_model_manager):
        ...
        item = _make_fact_item("f1", "user", "has_cat", "Mochi")
    ...
    def test_form_pairs_deduplicates(self, mock_store, mock_model_manager):
        ...
        personal = [
            _make_fact_item("f1", "user", "has_cat", "Mochi"),
            _make_fact_item("f2", "user", "has_cat", "Mochi"),  # duplicate concept
        ]
        wiki = [_make_wiki_item("w1", "Quantum Entanglement", "Physics content")]

        pairs = gen._form_pairs(personal, wiki, max_pairs=10)
        # Should deduplicate — only one pair with Mochi + Quantum Entanglement
        pair_keys = [frozenset([
