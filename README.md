...
_Snapshot: 2026-09-07 · git `778a37a`_

- **Python:** 862 files · 275,522 total lines · 211,518 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 9213 collected across 434 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
