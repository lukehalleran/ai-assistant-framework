...
[![Tests](https://img.shields.io/badge/tests-8%2C535-brightgreen.svg)](#testing)
...
_Snapshot: 2026-09-04 · git `e6e515d`_

- **Python:** 819 files · 263,681 total lines · 202,463 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 8535 collected across 397 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
