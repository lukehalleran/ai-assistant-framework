...
[![Tests](https://img.shields.io/badge/tests-6%2C725-brightgreen.svg)](#testing)
[![Docker Ready](https://img.shields.io/badge/docker-ready-blue.svg)](https://www.docker.com/)

> ~216K lines of Python (≈165K code) across 664 files | 14 ChromaDB collections | ~6,700 tests | 20 agentic tools | solo-built part-time over ~14 months
...
**6,725 tests across 303 test files** (exact live count in the badge above and `docs/METRICS_SNAPSHOT.md`; run `pytest --collect-only`). Coverage spans every subsystem — prompt-section eval (246), synthesis audit (40), knowledge graph, intent classification, web-search trigger, fact verification, escalation FSM, cross-deduplication, claim tracking, visual memory, and retrieval benchmarks (real embeddings, recall@K + MRR), among others.

<!-- METRICS:BEGIN -->
<!-- Generated by scripts/generate_doc_metrics.py — do not edit by hand. -->
_Snapshot: 2026-08-05 · git `2ddb00d`_

- **Python:** 664 files · 214,562 total lines · 163,711 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 6725 collected across 303 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
...
tests/                       # 303 test files, ~6,700 tests
```
