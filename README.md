...
[![Tests](https://img.shields.io/badge/tests-7%2C822-brightgreen.svg)](#testing)
...
_Snapshot: 2026-09-01 · git `21b0182`_

- **Python:** 760 files · 244,605 total lines · 187,577 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 7822 collected across 360 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
