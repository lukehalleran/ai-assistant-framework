...
[![Tests](https://img.shields.io/badge/tests-7%2C726-brightgreen.svg)](#testing)
[![Docker Ready](https://img.shields.io/badge/docker-ready-blue.svg)](https://www.docker.com/)

> ~220K lines of Python (≈168K code) across 673 files | 14 ChromaDB collections | ~7,400 tests | 20 agentic tools | solo-built part-time over ~15 months
...
_Snapshot: 2026-09-01 · git `6c8cdd8`_

- **Python:** 738 files · 235,117 total lines · 179,714 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 7726 collected across 357 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
