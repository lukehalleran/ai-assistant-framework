...
[![Tests](https://img.shields.io/badge/tests-7%2C763-brightgreen.svg)](#testing)
[![Docker Ready](https://img.shields.io/badge/docker-ready-blue.svg)](https://www.docker.com/)

> ~243K lines of Python (≈187K code) across 759 files | 14 ChromaDB collections | ~7,800 tests | 21 agentic tools | solo-built part-time over ~15 months
...
_Snapshot: 2026-09-01 · git `319e701`_

- **Python:** 759 files · 243,454 total lines · 186,710 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 7763 collected across 358 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
