...
[![Tests](https://img.shields.io/badge/tests-8%2C315-brightgreen.svg)](#testing)
...
_Snapshot: 2026-09-04 · git `bc3d43c`_

- **Python:** 795 files · 255,852 total lines · 196,488 non-blank/non-comment  <sub>(git ls-files '*.py', excl venv/ data/)</sub>
- **Tests:** 8315 collected across 386 test files  <sub>(python -m pytest --collect-only -q; pytest.ini exclusions applied)</sub>
