...
- **Edges**: Relations between entities (e.g., user → brother → sam).
...
- Possessive pattern extraction ("my brother Sam" → alias "brother" → sam)
...
related entities (Sam, Mom, Biscuit) to the search query.
...
"Sam is user's brother. Sam has a pet named Biscuit. Biscuit is a
golden retriever."
