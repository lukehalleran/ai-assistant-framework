...
1. **Phase 1.3 noisy facts:** Synthetic facts must include production-realistic
   ...
   resolver ("Sam" vs "August" vs "user's brother"), at least one fact below
...
- User has a brother named Sam (relationships)
...
```
- "August mentioned he might visit" (ambiguous — is this Sam? entity resolver test)
...
queries = [
    ...
    "I'm stressed about the brewery expansion and Sam's been helping me think through the stats",
]
