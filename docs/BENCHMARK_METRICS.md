...
|----------|---------|---------------|----------------|
| **Specific lookup** | "What's my goal about Lakewood?" | Single-gold R@1 (appropriate) | R@1 ✓ |
| **Current-state** | "How am I feeling?" | Newest-first ranking | Single-gold R@1 ✗ |
| **Aggregate** | "What are my goals?" / "Tell me about Sam" | Recall over fact set, nDCG | Single-gold R@1 ✗ |
