...
Usage:
    ...
    ranked = scorer.rank_memories(memories, query="tell me about Biscuit")

    # 3. With conversation context (for continuity scoring)
    context = [{"query": "how is my cat?", "response": "Biscuit is doing well!"}]
    ...
    memories = [
        {
            ...
            "response": "Your cat's name is Biscuit",
        ...
        {
            "content": "User has a cat named Biscuit. User enjoys cooking.",
