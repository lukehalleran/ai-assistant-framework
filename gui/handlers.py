...
- Behavior:
  ...
  - AGENTIC: If agentic_search.enabled and query triggers search, computation, OR memory recall, route through AgenticSearchController
    - 3-tier agentic gate [ENHANCED 2026-03-15]:
      ...
      - Tier 2: Entity match (instant) — query mentions a known entity from the knowledge graph (e.g., "Biscuit", "Sam")
...
async def handle_submit(
    ...
    if agentic_enabled:
        ...
        # short entity queries like "tell me about Biscuit" aren't filtered out.
