...
- Example: Daemon says "Daisy is your mom's black cat, male, with long fur"
  → {{"subject": "Daisy", "relation": "species", "object": "cat, black, long fur, male", "category": "hobbies", "confidence": 0.85, "user_connection": "user's mom's cat"}}
