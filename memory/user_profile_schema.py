...
RELATION_CATEGORY_MAP: Dict[str, ProfileCategory] = {
    ...
    "kavarin_dose": ProfileCategory.HEALTH,
    "kavarin_effects": ProfileCategory.HEALTH,
...
_PREFIX_CATEGORY_MAP: Dict[str, ProfileCategory] = {
    ...
    "food": ProfileCategory.HEALTH, "kavarin": ProfileCategory.HEALTH,
...
_CATEGORY_TOKENS: Dict[ProfileCategory, Set[str]] = {
    ...
    ProfileCategory.HEALTH: {
        ...
        "nap", "insomnia", "apnea", "disorder", "mental", "dexivar", "vryalar",
        "meal", "food", "drink", "energy", "caffeine", "alcohol", "headache",
        "blood", "pressure", "kavarin", "feeling",
    },
